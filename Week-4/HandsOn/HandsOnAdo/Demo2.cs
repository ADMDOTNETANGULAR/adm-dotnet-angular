...
namespace HandsOnAdo
{
    ...
    internal class Demo2
    {
        static void Main()
        {
           using (SqlConnection sqlConnection = new SqlConnection("Data Source=DESKTOP-4O1D65I\\SQLEXPRESS;Initial Catalog=ADMDOTNET;Integrated Security=True;Encrypt=True;Trust Server Certificate=True"))
            {
